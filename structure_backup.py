    ...
    def process_files(self):
        ...
        for file in files:
            ...
            for feature in features:
                ...
                raw_value = properties.get("1980", my_radius)  # Default to my_radius if "1980" not present
