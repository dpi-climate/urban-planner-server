...
def json_to_csv_with_timestamps(raw_file_path, csv_file_path):
    ...
    with open(csv_file_path, 'w', newline='', encoding='utf-8') as csvfile:
        ...
        for feature in features:
            ...
            # Get properties for the feature
            properties = feature.get("properties", {})

            # Build row with lat, lon, and then values for each timestamp
            row = [lat, lon]
...
# Example usage:
# json_to_csv_with_timestamps("path_to_raw_file.json", "output_file.csv")
...
def build_prcp():
    ...
    json_to_csv_with_timestamps(raw_prcp_path, f"{processed_path}/pt_prcp.csv")
...
def build_tmin():
    ...
    json_to_csv_with_timestamps(raw_min_temp_path, f"{processed_path}/pt_tmin.csv")
...
def build_tmax():
    ...
    json_to_csv_with_timestamps(raw_max_temp_path, f"{processed_path}/pt_tmax.csv")
