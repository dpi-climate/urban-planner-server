...
from consts import raw_files_dir, processed_risk_dir
...
if __name__ == "__main__":
    geojson_file = f"{raw_files_dir}/Illinois_prcp_risks_round.json"
    feather_file = f"{processed_risk_dir}/Illinois_prcp_risks_round.feather"
